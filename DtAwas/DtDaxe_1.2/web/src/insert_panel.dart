...
class InsertPanel {
  ...
  void update(Position pos) {
    ...
    h.DivElement branddiv = new h.DivElement();
    branddiv.classes.add("dtawas-editor-branddiv");
    h.ImageElement brandimg = new h.ImageElement();
    brandimg.setAttribute("src", "images/brandimg.png");
    brandimg.classes.add("dtawas-editor-brandimg");
    h.ParagraphElement versiontag = new h.ParagraphElement();
    versiontag.text = applicationVersion;
    branddiv.append(brandimg);
    branddiv.append(versiontag);
    divInsert.append(branddiv); 
  }
